...
namespace BackendFinal.Migrations
{
    ...
    [Migration("20230203190522_Blogg")]
    partial class Blogg
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend_Final.Database.Models.Blog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Backend_Final.Database.Models.BlogAndBlogCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Backend_Final.Database.Models.BlogAndBlogTag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Backend_Final.Database.Models.BlogCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Backend_Final.Database.Models.BlogDisplay", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("BlogDisplays");
                });

            modelBuilder.Entity("Backend_Final.Database.Models.BlogTag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Backend_Final.Database.Models.BlogAndBlogCategory", b =>
                {
                    b.HasOne("Backend_Final.Database.Models.BlogCategory", "Category")
                        .WithMany("BlogAndCategories")
                        .HasForeignKey("BlogCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Backend_Final.Database.Models.Blog", "Blog")
                        .WithMany("BlogAndCategories")
            ...
            modelBuilder.Entity("Backend_Final.Database.Models.BlogAndBlogTag", b =>
                {
                    ...
                    b.HasOne("Backend_Final.Database.Models.BlogTag", "Tag")
                        .WithMany("Tags")
            ...
            modelBuilder.Entity("Backend_Final.Database.Models.BlogCategory", b =>
                {
                    b.HasOne("Backend_Final.Database.Models.BlogCategory", null)
                        .WithMany("Categories")
                        .HasForeignKey("BlogCategoryId");
                });
